...
export namespace main {
	...
	export class MoveDesktopPhotoInput {
	    id: string;
	    sourceId: string;
	    fromPath: string;
	    fromThumbPath: string;
	    toFolder: string;
	
	    static createFrom(source: any = {}) {
	        return new MoveDesktopPhotoInput(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.id = source["id"];
	        this.sourceId = source["sourceId"];
	        this.fromPath = source["fromPath"];
	        this.fromThumbPath = source["fromThumbPath"];
	        this.toFolder = source["toFolder"];
	    }
	}
	export class MoveDesktopPhotosInput {
	    moves: MoveDesktopPhotoInput[];
	
	    static createFrom(source: any = {}) {
	        return new MoveDesktopPhotosInput(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.moves = this.convertValues(source["moves"], MoveDesktopPhotoInput);
	    }
