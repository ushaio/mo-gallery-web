      ...
      >
        ...
        {imageFailed || !activeSrc ? (
          ...
          <img
            ...
            style={{ width: 'auto', height: '100%', maxWidth: '100%', maxHeight: '100%', transform: `translate(${offset.x}px, ${offset.y}px) scale(${zoom})`, transformOrigin: 'center center', cursor: zoom > 1 || showOriginal ? 'grab' : 'default' }}
          />
        )}
