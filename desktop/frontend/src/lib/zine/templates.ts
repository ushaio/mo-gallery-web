...
export const ZINE_TEMPLATES: TemplateDef[] = [
  ...
  { id: 'two-up', nameKey: 'admin.zine_template_two_up', pageLayout: 'two-up', buildSlots: (w, h) => [imageSlot('left', w, margin, margin, w - margin * 2, (h - margin * 2 - gap) / 2, 1), imageSlot('left', w, margin, margin + (h - margin * 2 + gap) / 2, w - margin * 2, (h - margin * 2 - gap) / 2, 2), imageSlot('right', w, margin, margin, w - margin * 2, (h - margin * 2 - gap) / 2, 3), imageSlot('right', w, margin, margin + (h - margin * 2 + gap) / 2, w - margin * 2, (h - margin * 2 - gap) / 2, 4)] },
