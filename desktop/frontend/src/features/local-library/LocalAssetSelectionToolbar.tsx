...
export function LocalAssetSelectionToolbar({
        ...
        return (
                <div className="pointer-events-none absolute bottom-14 left-1/2 z-30 -translate-x-1/2">
                        <div
                                className="pointer-events-auto flex items-center gap-0.5 rounded-xl border border-white/10 px-1.5 py-1.5 shadow-[inset_0_1px_0_rgba(255,255,255,0.1),0_18px_42px_-24px_rgba(15,23,42,0.8)] backdrop-blur-xl"
                                style={{
                                        backgroundColor:
                        ...
                        >
                                ...
                                <div ref={menuRef} className="relative">
                                        ...
                                        {uploadMenuOpen && canUpload && (
                                                <div
                                                        role="menu"
                                                        className="absolute bottom-full left-1/2 z-50 mb-2 min-w-52 -translate-x-1/2 overflow-hidden rounded-lg border bg-popover p-1 text-popover-foreground shadow-xl"
                                                        style={{
                                                                borderColor:
                                                                        "var(--border)",
                                                        }}
                                                >
                                                        ...
                                                        <button
                                                                ...
                                                                className="flex min-h-8 w-full items-center gap-2 rounded-md px-2 py-1.5 text-left text-xs hover:bg-accent"
                                                        >
                                                                <Settings2
                                                                        size={
                                                                                14
                                                        ...
                                                        {storageSourcesLoading ? (
                                                                <div className="flex min-h-8 items-center gap-2 px-2 py-1.5 text-xs text-muted-foreground">
                                                                        <Loader2
                                                                                size={
                                                                                        14
                                                                                }
                                                                ...
                                                                storageSources.map(
                                                                        (
                                                                                ...
                                                                                <button
                                                                                        ...
                                                                                        className="flex min-h-8 w-full items-center rounded-md px-2 py-1.5 text-left text-xs hover:bg-accent"
                                                                                >
